// Chuckles the Bot — Agent 1
// Polls for messages from Bonnie and replies via Telegram
...
const BOT_NAME = 'Chuckles';
const PARTNER_NAME = 'Bonnie';
...
bot.on('message', (msg) => {
  ...
  if (msg.from.is_bot && msg.from.username === 'Chuckles_the_bot') return;
